...
<body onLoad='ShowTables(); SelectTableRep();'>
	<div id="header_h">
		<div>
			...
			echo "<a id='help' target='_blank' style='position: Fixed; Left: 88%; Top: 5px; font-size: 24pt;' href='help/index.html'>Помощь</a>";
			...
			<div id="no-print">
				...
				echo "<input class=button4 type='button' name='button_search' onClick='CustomReport();' value='Сформировать'/>";
				?>
				<br>
				...
				<a id='help' target='_blank' style='position: Fixed; Left: 88%; Top: 5px; font-size: 24pt;' href='help/index.html'>Помощь</a>
			</div>
